...
var _userModelExample = _interopRequireDefault(require("./user.model.example.js"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _userModelExample["default"].find();
        case 3:
          users = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return _userModelExample["default"].findById(id);
        case 4:
          user = _context2.sent;
          if (user) {
            _context2.next = 7;
...
var createUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request, response) {
    var _request$body, name, lastname, age, numberPhone, email, user;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _request$body = request.body, name = _request$body.name, lastname = _request$body.lastname, age = _request$body.age, numberPhone = _request$body.numberPhone, email = _request$body.email;
        ...
        case 3:
          _context3.prev = 3;
          _context3.next = 6;
          return _userModelExample["default"].create({
            name: name,
            lastname: lastname,
            age: age,
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 2;
          _context4.next = 5;
          return _userModelExample["default"].findByIdAndUpdate(id, data, {
            "new": true
          });
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return _userModelExample["default"].findByIdAndDelete(id);
        case 4:
